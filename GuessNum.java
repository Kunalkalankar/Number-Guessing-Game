...
public class GuessNum {
    public static void guessNum() {
        ...
        while( attempts<3 ){
            ...
            if(guess>rand_num) {
                System.out.println("\nsorry! Your number is less than.Please enter valid number. "+guess);
            }

            else if(guess<rand_num) {
                System.out.println("\nsorry! Your number is greater than.Please enter valid number "+guess);
            }
                ...
                System.out.println("\nThe number is "+guess);
                System.out.println("\nYou scored: "+points);
                System.out.println("\nYou want to play the game again? if Yes press 1 ");
